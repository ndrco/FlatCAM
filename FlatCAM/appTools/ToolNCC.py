...
class NccUI:
	...
	def __init__(self, layout, app):
		...
		separator_line.setFrameShape(QtWidgets.QFrame.HLine)
		separator_line.setFrameShadow(QtWidgets.QFrame.Sunken)
		self.grid3.addWidget(separator_line, 27, 0, 1, 2)
		...
		self.grid3.addWidget(self.apply_param_to_all, 28, 0, 1, 2)
		...
		self.grid3.addWidget(self.gen_param_label, 30, 0, 1, 2)
		...
		self.grid3.addWidget(self.ncc_rest_cb, 31, 0, 1, 2)
		...
		self.grid3.addWidget(self.rest_nccmarginlabel, 32, 0)
		self.grid3.addWidget(self.rest_ncc_margin_entry, 32, 1)
		...
		self.grid3.addWidget(self.rest_ncc_connect_cb, 33, 0)
		...
		self.grid3.addWidget(self.rest_ncc_contour_cb, 33, 1)
		...
		self.grid3.addWidget(self.rest_ncc_choice_offset_cb, 34, 0)
		...
		self.grid3.addWidget(self.rest_ncc_offset_spinner, 34, 1)
		...
		self.grid3.addWidget(self.select_label, 35, 0, )
		self.grid3.addWidget(self.select_combo, 35, 1)
		...
		self.grid3.addWidget(self.reference_combo_type_label, 37, 0, )
		self.grid3.addWidget(self.reference_combo_type, 37, 1)
		...
		self.grid3.addWidget(self.reference_combo, 39, 0, 1, 2)
		...
		self.grid3.addWidget(self.area_shape_label, 41, 0)
		self.grid3.addWidget(self.area_shape_radio, 41, 1)
		...
		self.grid3.addWidget(self.valid_cb, 43, 0, 1, 2)

		separator_line = QtWidgets.QFrame()
		separator_line.setFrameShape(QtWidgets.QFrame.HLine)
		separator_line.setFrameShadow(QtWidgets.QFrame.Sunken)
		self.grid3.addWidget(separator_line, 45, 0, 1, 2)
