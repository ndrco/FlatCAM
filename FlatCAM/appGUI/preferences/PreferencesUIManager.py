...
from settings import theme, set_theme
...
class PreferencesUIManager:
	...
	def __init__(self, defaults: FlatCAMDefaults, data_path: str, ui, inform):
		...
		self.defaults_form_fields = {
			...
			"geometry_entry_ramp":      self.ui.geometry_defaults_form.geometry_opt_group.entry_ramp_cb,
			"geometry_entry_ramp_start_z": self.ui.geometry_defaults_form.geometry_opt_group.entry_ramp_start_z_entry,
			"geometry_entry_ramp_length": self.ui.geometry_defaults_form.geometry_opt_group.entry_ramp_length_entry,
			"geometry_entry_ramp_overcut": self.ui.geometry_defaults_form.geometry_opt_group.entry_ramp_overcut_entry,
			"geometry_entry_ramp_recovery_length": \
				self.ui.geometry_defaults_form.geometry_opt_group.entry_ramp_recovery_length_entry,
			"geometry_entry_ramp_feedrate": self.ui.geometry_defaults_form.geometry_opt_group.entry_ramp_feedrate_entry,
	...
	def on_save_button(self, save_to_file=True):
		...
		ge_new_val = self.ui.general_defaults_form.general_app_group.ge_radio.get_value()

		if theme_new_val != theme() or ge != ge_new_val:
			# change theme or graphic engine
